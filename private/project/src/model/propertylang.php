 ...
 * @package model
 */
class PropertyLang implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="property_lang";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","property_id","lang_id","value",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('property_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"property_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('property_lang_property_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"lang_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('property_lang_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("id","property_id","value",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("id","property_id","value",);

	/**
	* @param array $attributesArray
	*/
	public function PropertyLang(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("PropertyLang");
