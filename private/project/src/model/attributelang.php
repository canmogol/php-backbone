 ...
 * @package model
 */
class AttributeLang implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="attribute_lang";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","attribute_id","lang_id","value",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('attribute_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"attribute_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('attribute_lang_attribute_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"lang_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('attribute_lang_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("id","attribute_id","value",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("id","attribute_id","value",);

	/**
	* @param array $attributesArray
	*/
	public function AttributeLang(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("AttributeLang");
