 ...
 * @package model
 */
class AttributeType implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="attribute_type";
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('attribute_type_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("name",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("name",);

	/**
	* @param array $attributesArray
	*/
	public function AttributeType(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("AttributeType");
