...
class PropertyType implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="property_type";
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('property_type_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	...
	*/
	public function PropertyType(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("PropertyType");
