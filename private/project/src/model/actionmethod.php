 ...
 * @package model
 */
class ActionMethod implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="action_method";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","action","method",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('action_method_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("action","method",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("action","method",);

	/**
	* @param array $attributesArray
	*/
	public function ActionMethod(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("ActionMethod");
