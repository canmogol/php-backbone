...
class Stack implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","name");
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('stack_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("name","default_stack",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("name","default_stack",);

	/**
	* @param array $attributesArray
	*/
	public function Stack(array $attributesArray = array()){
	...
	*/
    ...
    /**
     * @param string $defaultStack
     */
    public function setDefaultStack($defaultStack) {
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("Stack");
