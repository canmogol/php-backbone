 ...
 * @package model
 */
class GroupActionMethod implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="group_action_method";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","group_id","action_method_id",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('group_action_method_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	...
	private $relationsArray = array(
		"action_method_id"=>array(
			'relationTable'=>'action_method',
			'relationField'=>'id',
			'relationClass'=>'ActionMethod',
			'viewField'=>'action',
			),
		);
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("group_id","action_method_id",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("group_id","action_method_id",);

	/**
	* @param array $attributesArray
	*/
	public function GroupActionMethod(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("GroupActionMethod");
