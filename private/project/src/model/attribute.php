...
class Attribute implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","attribute_type_id","name",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('attribute_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	...
	private $relationsArray = array(
		"attribute_type_id"=>array(
			'relationTable'=>'attribute_type',
			'relationField'=>'id',
			'relationClass'=>'AttributeType',
			'viewField'=>'name',
			),
		);
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("attribute_type_id","name",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("attribute_type_id","name",);

	/**
	* @param array $attributesArray
	*/
	public function Attribute(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("Attribute");
