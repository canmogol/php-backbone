...
<form action="?stack=property&amp;action=property&amp;method=update" method="POST">
<table>
	<tbody>
	...
	<tr>
		...
		<td>
			...
			<xsl:for-each select="/root/property_types/property_type">
				<xsl:choose>
					<xsl:when test="id = /root/property_types/property_type">
