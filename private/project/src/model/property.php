...
class Property implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","property_type_id",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('property_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	...
	private $relationsArray = array(
		"property_type_id"=>array(
			'relationTable'=>'property_type',
			'relationField'=>'id',
			'relationClass'=>'PropertyType',
			'viewField'=>'name',
			),
		);
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("property_type_id",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("property_type_id",);

	/**
	* @param array $attributesArray
	*/
	public function Property(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("Property");
