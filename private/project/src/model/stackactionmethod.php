 ...
 * @package model
 */
class StackActionMethod implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="stack_action_method";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","stack_id","action_method_id",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('stack_action_method_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("stack_id","action_method_id",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("stack_id","action_method_id",);

	/**
	* @param array $attributesArray
	*/
	public function StackActionMethod(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("StackActionMethod");
