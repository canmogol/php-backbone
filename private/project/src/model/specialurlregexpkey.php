 ...
 * @package model
 */
class SpecialUrlRegexpKey implements Model {
	...
	**/
	 ...
	 * @var string
	 * */
	private $tableName="special_url_regexp_key";
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","special_url_id","key","position",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('special_url_regexp_key_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	
		"special_url_id"=>array(
			"type"=>"int",
			"default_value"=>"",
			"max"=>"",
			"validator"=>"isInteger",
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("special_url_id","key","position",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("special_url_id","key","position",);

	/**
	* @param array $attributesArray
	*/
	public function SpecialUrlRegexpKey(array $attributesArray = array()){
	...
	*/
	...
	/**
	* @param int $specialUrlId
	* @return void
	*/
	public function setSpecialUrlId($specialUrlId){
		$this->specialUrlId=$specialUrlId;
	}//end of setSpecialUrlId
	
	/**
	* @return int
	*/
	public function getSpecialUrlId(){
		return $this->specialUrlId;
	}//end of getSpecialUrlId
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("SpecialUrlRegexpKey");
