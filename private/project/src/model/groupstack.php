 ...
 * @package model
 */
class GroupStack implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","group_id","stack_id",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('group_stack_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("group_id","stack_id",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("group_id","stack_id",);

	/**
	* @param array $attributesArray
	*/
	public function GroupStack(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("GroupStack");
