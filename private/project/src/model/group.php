...
class Group implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","name","description",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('group_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("name","description",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("name","description",);

	/**
	* @param array $attributesArray
	*/
	public function Group(array $attributesArray = array()){
	...
	*/
     ...
     */
    public function setActionMethods($actionMethods) {
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("Group");
