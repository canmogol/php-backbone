 ...
 * @package model
 */
class NodeLang implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","node_id","lang_id","value","is_visible","creation_date","last_update",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('node_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"node_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('node_lang_node_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
		...
		"lang_id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('node_lang_lang_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("id","node_id","value","is_visible","creation_date","last_update",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("id","node_id","value","is_visible","creation_date","last_update",);

	/**
	* @param array $attributesArray
	*/
	public function NodeLang(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("NodeLang");
