...
class UserGroup implements Model {
	...
	**/
	 ...
	 * @var array
	 */
	private $dbProperties = array("id","group_id","user_id",);
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('user_group_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	 ...
	 * @var array
	 */
	private $dbPropertiesUpdate = array("group_id","user_id",);
	
	/**
	 * @var array
	 */
	private $dbPropertiesInsert = array("group_id","user_id",);

	/**
	* @param array $attributesArray
	*/
	public function UserGroup(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("UserGroup");
