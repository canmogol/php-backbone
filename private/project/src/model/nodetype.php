 ...
 * @package model
 */
class NodeType implements Model {
	...
	**/
	...
	private $columnProperties = array(
		"id"=>array(
			"type"=>"int",
			"default_value"=>"nextval('node_type_id_seq'::regclass)",
			"max"=>"",
			"validator"=>"isInteger",
			"notnull"=>true),
	...
	*/
	public function NodeType(array $attributesArray = array()){
	...
	*/
	public function setAttributesArray(array $attributesArray){
		...
		$methodsArray = get_class_methods("NodeType");
